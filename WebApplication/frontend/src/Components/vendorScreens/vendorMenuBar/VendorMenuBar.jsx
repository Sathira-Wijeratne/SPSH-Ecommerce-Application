  ...
  return (
    <div className="menu">
      ...
      <div className="menulist">
        ...
        <a href="#" className="item" onClick={onClickAddProduct}>
          Add Products
        </a>
        <a href="#" className="item" onClick={onClickshipmentManagement}>
          Order Management
        </a>
        <a href="#" className="item" onClick={onClickstockManagement}>
          Stock Management
        </a>
      </div>
